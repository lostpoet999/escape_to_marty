...
## seconds the coin holds fully visible between fades
@export var visible_hold_time: float = 14.0
## seconds the coin stays hidden before fading back in
@export var hidden_hold_time: float = 3.0
## spin speed in degrees per second around the vertical axis; direction is picked per coin
