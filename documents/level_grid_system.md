...
- **Brick Grid:** 24 wide × 10 tall
- **Grid Pixel Size:** 1536 x 640
- **Remaining Width:** 384px (UI panel + side walls)
- **Remaining Height:** 440px (top wall + combat zone + paddle + death wall)
- **Combat Zone:** ~4-5 cell-heights below the grid for enemies and paddle
- **PNG Import Size:** 24 × 10 pixels (one pixel = one cell) **Plan on doing a pixel png 24x10 to level import if its not too crazy to pull off.**
